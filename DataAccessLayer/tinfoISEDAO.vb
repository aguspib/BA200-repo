...
#Region "CRUD Methods"
        ...
        Public Function ReadAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.ReadAll", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function ReadAll(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.ReadAll (2)", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing And Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function ReadISESetting(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, ByVal pISESetting As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.ReadISESetting", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing And Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function CreateNewMasterData(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pISEInfoDS As ISEInformationDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.CreateNewMasterData", EventLogEntryType.Error, False)
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tinfoISEDAO.Update (2)", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
