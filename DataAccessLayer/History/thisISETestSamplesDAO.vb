...
#Region "CRUD Methods"
        ...
        Public Function ReadByISETestID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pISETestID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "thisISETestSamplesDAO.ReadByISETestID", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisISETestSamplesDS As HisISETestSamplesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "thisISETestSamplesDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
