...
#Region "CRUD Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisOFFSTestsDS As HisOFFSTestSamplesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "thisOffSystemTestSamplesDAO.Create", EventLogEntryType.Error, False)
            End Try
        ...
        Public Function CloseOFFSTestSample(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisOFFSTestID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "thisOffSystemTestSamplesDAO.CloseOFFSTestSample", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function DeleteClosedNotInUse(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "thisOffSystemTestSamplesDAO.DeleteClosedNotInUse", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function ReadByOFFSTestID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pOFFSTestID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "thisOffSystemTestSamplesDAO.ReadByOFFSTestIDAndSampleType", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisOFFSTestsDS As HisOFFSTestSamplesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "thisOffSystemTestSamplesDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
#End Region
