...
#Region "CRUD"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestCalibValueDS As TestCalibratorValuesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "tparTestCalibratorValuesDAO.Create", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function DeleteByTestsCalibratorID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestCalibratorID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tparTestCalibratorValuesDAO.Delete", EventLogEntryType.Error, False)
            End Try
        ...
        Public Function ReadByTestIDSampleType(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, ByVal pSampleType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, " tparTestCalibratorsDAO.ReadByTestIDSampleType ", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestCalibValueDS As TestCalibratorValuesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tparTestCalibratorValuesDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
...
#Region "Other Methods"
        ...
        Public Function GetNumberOfPointsDefined(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, ByVal pSampleType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tparTestCalibratorValuesDAO.GetNumberOfPointsDefined", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
...
#Region "TO REVIEW!!"
        ...
        Public Function ReadByTestCalibratorIDAndTestID(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, " tparTestCalibratorsDAO.ReadByTestCalibratorIDAndTestID ", EventLogEntryType.Error, False)
            Finally
