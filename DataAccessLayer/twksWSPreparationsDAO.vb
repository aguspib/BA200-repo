...
#Region "CRUD Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pPreparation As WSPreparationsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.Create", EventLogEntryType.Error, False)
            End Try
            Return dataToReturn
        End Function
        ...
        Public Function Read(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pPreparationID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.Read", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function ReadAll(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.ReadAll", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return dataToReturn
        ...
        Public Function UpdateStatus(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pPreparationID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.UpdateStatus", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function Delete(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pPreparationID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.Delete", EventLogEntryType.Error, False)
            End Try
            Return dataToReturn
        End Function
        ...
        Public Function DeleteAll(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.DeleteAll", EventLogEntryType.Error, False)
            End Try
            Return dataToReturn
        End Function
#End Region
...
#Region "Other Methods"
        ...
        Public Function GeneratePreparationID(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.GeneratePreparationID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function ResetWS(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, ByVal pWorkSessionID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.ResetWS", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function ReadCuvettesContaminatedAfterRecoveryResults(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pMinPrepID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSPreparationsDAO.ReadCuvettesContaminatedAfterRecoveryResults", EventLogEntryType.Error, False)
