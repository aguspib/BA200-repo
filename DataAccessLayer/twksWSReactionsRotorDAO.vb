...
#Region "C R U D"
        ...
        Public Function Create(ByVal pDBConnection As SqlConnection, ByVal pReactionRotorDS As ReactionsRotorDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.Create", EventLogEntryType.Error, False)
            End Try
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.Read", EventLogEntryType.Error, False)
        '    End Try
        '    Return myGlobalDataTO
        'End Function
        ...
        Public Function Update(ByVal pDBConnection As SqlConnection, ByVal pReactionRotorDS As ReactionsRotorDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function Delete(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.Delete", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
...
#Region "ALL & RESET"
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.ReadAll", EventLogEntryType.Error, False)
        '    End Try
        '    Return myGlobalDataTO
        'End Function
        ...
        Public Function DeleteAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.DeleteAll", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function GetAllWellsLastTurn(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.GetAllWellsLastTurn", EventLogEntryType.Error, False)
        ...
        Public Function UpdateRotorTurnAfterReset(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pPreviousWorkSessionRotorTurn As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.UpdateRotorTurnAfterReset", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function UpdateWellContentAndStatusAfterReset(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.UpdateWellContentAndStatusAfterReset", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
...
#Region "Other business methods"
        ...
        Public Function ReadWellHistoricalUse(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.ReadWellHistoricalUse", EventLogEntryType.Error, False)
        ...
        Public Function UpdateMAXRotorTurnRecord(ByVal pDBConnection As SqlConnection, ByVal pReactionRotorDS As ReactionsRotorDS) As GlobalDataTO
            ...
            Try
                ...
                '' XBC 03/07/2012 - time estimation
                'Dim myLogAcciones As New ApplicationLogManager()
                'myLogAcciones.CreateLogActivity("Update Reactions Rotor " & _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.UpdateMAXRotorTurnRecord", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function SetCurrentTurnFlagToFalse(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pWellNumber As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.SetCurrentTurnFlagToFalse", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function SetValuesForWashingStationWells(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pWellList As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.SetValuesForWashingStationWells", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function SetToEmptyTheWellsInWashStation(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.SetToEmptyTheWellsInWashStation", EventLogEntryType.Error, False)
            End Try
            Return myGlobalDataTO
        End Function
        ...
        Public Function ReadReactionsDetails(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "twksWSReactionsRotorDAO.ReadReactionsDetails", EventLogEntryType.Error, False)
