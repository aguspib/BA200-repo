...
#Region "CRUD Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pRepetitionsToAdd As WSRepetitionsToAddDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.Create", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function Delete(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pRepetitionsToAdd As WSRepetitionsToAddDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.Delete", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function DeleteAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, ByVal pWorkSessionID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.DeleteAll", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function Read(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pRepetitionsToAdd As WSRepetitionsToAddDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.Read", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function ReadAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, ByVal pWorksessionID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.ReadAll", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pRepetitionsToAdd As WSRepetitionsToAddDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSRepetitionsToAddDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
