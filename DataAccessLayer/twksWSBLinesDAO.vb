...
#Region "Others Methods"
        ...
        ''' STATIC: (light counts are get from twksWSBLinesByWell and dark counts are get from twksWSBLines (STATIC))
        ''' DYNAMIC: (light counts are get from twksWSBLinesByWell and dark counts are get from twksWSBLines (DYNAMIC)) - 1st try WRONG!!
        '''         Do not delete code, because it not affects the STATIC calculations and maybe the business dynamic develop here must be reactivated again
        ''' </summary>
        ''' <param name="pDBConnection">Open DB Connection</param>
        ''' <param name="pAnalyzerID">Analyzer Identifier</param>
        ...
        Public Function DeleteBLinesValues(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSBLinesDAO.DeleteBLinesValues", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
...
#Region "DYNAMIC base line methods"
        ...
        Public Function ReadValuesForCalculationsDYNAMIC(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSBLinesDAO.ReadValuesForCalculationsDYNAMIC", EventLogEntryType.Error, False)
        ...
        Public Function GetByWaveLengthDYNAMIC(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSBLinesDAO.GetByWaveLengthDYNAMIC", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function DeleteByType(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pType As String, ByVal pBaseLineIDSkipped As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSBLinesDAO.DeleteByType", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function UpdateBaseLineIDByType(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal NewBaseLineID As Integer, ByVal pType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSBLinesDAO.UpdateBaseLineIDByType", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
