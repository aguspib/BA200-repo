...
#Region "TO DELETE - OLD FUNCTIONS"
        ...
        '                cmdText &= " INSERT INTO tqcResultAlarms (QCTestSampleID, QCControlLotID, RunsGroupNumber, RunNumber, AlarmID)" & Environment.NewLine
        '                cmdText &= " VALUES ("
        '                cmdText &= resultAlarmRow.QCTestSampleID.ToString() & ", " & Environment.NewLine
        '                cmdText &= resultAlarmRow.QCControlLotID.ToString() & ", " & Environment.NewLine
        '                cmdText &= resultAlarmRow.RunsGroupNumber.ToString() & ", " & Environment.NewLine
        '                cmdText &= resultAlarmRow.RunNumber.ToString & ", " & Environment.NewLine
        '                cmdText &= "'" & resultAlarmRow.AlarmID & "') " & Environment.NewLine
        ...
        '        myLogAcciones.CreateLogActivity(ex.Message, "tqcResultAlarmsDAO.Create", EventLogEntryType.Error, False)
        '    End Try
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "tqcResultAlarmsDAO.Delete", EventLogEntryType.Error, False)
        '    End Try
        '    Return myGlobalDataTO
        'End Function
        ...
        '''' </remarks>
        'Public Function ReadByRunsGroupNumberOLD(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCTestSampleID As Integer, ByVal pQCControlLotID As Integer, _
        ...
        '                Dim cmdText As String = " SELECT * FROM tqcResultAlarms " & Environment.NewLine & _
        '                                        " WHERE  QCTestSampleID = " & pQCTestSampleID.ToString() & Environment.NewLine & _
        '                                        " AND    QCControlLotID = " & pQCControlLotID.ToString() & Environment.NewLine & _
        '                                        " AND    RunsGroupNumber = " & pRunsGroupNumber.ToString() & Environment.NewLine & _
        '                                        " ORDER BY RunNumber "
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "tqcResultsDAO.ReadByRunsGroupNumber", EventLogEntryType.Error, False)
        '    Finally
        ...
        '''' <summary>
        '''' For the informed QCTestSampleID/QCControlLotID, get all Results having alarms, getting also the description
        ...
        ''''          QCTestSampleID/QCControlLotID</returns>
        '''' <remarks>
        ...
        '            dbConnection = DirectCast(myGlobalDataTO.SetDatos, SqlClient.SqlConnection)
        '            If (Not dbConnection Is Nothing) Then
        '                Dim cmdText As String = " SELECT RA.RunNumber, RA.AlarmID, MR.ResourceText AS AlarmDesc " & Environment.NewLine & _
        '                                        " FROM   tqcResultAlarms RA LEFT JOIN tfmwAlarms A ON RA.AlarmID = A.AlarmID " & Environment.NewLine & _
        '                                                                  " INNER JOIN tfmwMultiLanguageResources MR ON A.DescResourceID = MR.ResourceID " & Environment.NewLine & _
        '                                        " WHERE RA.QCTestSampleID =" & pQCTestSampleID.ToString() & Environment.NewLine & _
        '                                        " AND   RA.QCControlLotID =" & pQCControlLotID.ToString() & Environment.NewLine & _
        '                                        " AND   RA.RunsGroupNumber =" & pRunsGroupNumber.ToString() & Environment.NewLine & _
        '                                        " AND   MR.LanguageID = '" & pCurrentLanguage & "' " & Environment.NewLine & _
        '                                        " UNION " & Environment.NewLine & _
        '                                        " SELECT RA.RunNumber, RA.AlarmID, PMD.FixedItemDesc AS AlarmDesc " & Environment.NewLine & _
        '                                        " FROM   tqcResultAlarms RA LEFT JOIN tfmwPreloadedMasterData PMD ON RA.AlarmID = PMD.ItemID " & Environment.NewLine & _
        '                                        " WHERE  RA.QCTestSampleID = " & pQCTestSampleID.ToString() & Environment.NewLine & _
        '                                        " AND    RA.QCControlLotID = " & pQCControlLotID.ToString() & Environment.NewLine & _
        '                                        " AND   RA.RunsGroupNumber =" & pRunsGroupNumber.ToString() & Environment.NewLine & _
        '                                        " AND    PMD.SubTableID = '" & GlobalEnumerates.PreloadedMasterDataEnum.QC_MULTIRULES.ToString & "' " & Environment.NewLine & _
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "tqcResultsDAO.GetAlarmsAndDescriptions", EventLogEntryType.Error, False)
        '    Finally
        '        If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
        '    End Try
        '    Return myGlobalDataTO
