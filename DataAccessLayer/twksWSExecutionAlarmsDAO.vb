...
#Region "CRUD Methods"
        ...
        Public Function Read(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pExecutionID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.Read", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function Add(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pWSExecutionAlarms As WSExecutionAlarmsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.Add", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function Delete(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pWSExecutionAlarms As WSExecutionAlarmsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.Delete", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
...
#Region "Other Methods"
        ...
        Public Function ResetWS(ByVal pDBConnection As SqlConnection, ByVal pAnalyzerID As String, ByVal pWorkSessionID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.ResetWS", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function DeleteAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pExecutionID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.DeleteAll", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function ReadAlarmsForAverageResult(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerID As String, ByVal pWorkSessionID As String, _
                ...
                If (Not resultData.HasError AndAlso Not resultData.SetDatos Is Nothing) Then
                    ...
                    If (Not dbConnection Is Nothing) Then
                        Dim cmdText As String = " SELECT DISTINCT EA.AlarmID " & vbCrLf & _
                                                ...
                                                " WHERE  EA.AlarmID NOT IN ('" & AlarmEnumerates.Alarms.CONC_REMARK7.ToString & "', " & vbCrLf & _
                                                                           "'" & AlarmEnumerates.Alarms.CONC_REMARK8.ToString & "') " & vbCrLf & _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "twksWSExecutionAlarmsDAO.ReadAlarmsForAverageResult", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
