...
#Region "CRUD Methods"
        ...
        Public Function CreateNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pCumulatedResultDS As CumulatedResultsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "tqcLastCumulatedValuesDAO.Create", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function DeleteNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCTestSampleID As Integer, ByVal pQCControlLotID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, " tqcLastCumulatedValuesDAO.Delete ", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function ReadNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCTestSampleID As Integer, ByVal pQCControlLotID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tqcLastCumulatedValuesDAO.Read", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function UpdateNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pCumulatedResultDS As CumulatedResultsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tqcLastCumulatedValuesDAO.Update", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
        ...
        Public Function UpdateCalculatedFieldsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCTestSampleID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "tqcLastCumulatedValuesDAO.UpdateCalculatedFields", EventLogEntryType.Error, False)
            End Try
            Return resultData
        End Function
#End Region
