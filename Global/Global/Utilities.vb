...
#Region "Public Methods"
        ...
        Public Function FormatToSingle(ByVal pValue As String) As Single
            ...
            Try
                ...
                Else
                    ...
                    GlobalBase.CreateLogActivity("Protection! The input parameter is not numeric (" & pValue.ToString & ")", "Utilities.FormatToSingle ", EventLogEntryType.Error, False)
                    returnValue = 0
                End If
        ...
        Public Function CalculateStandardDeviation(ByVal pCollection As List(Of Single)) As Single
            ...
            Catch ex As Exception
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "Utilities.CalculateStandardDeviation", EventLogEntryType.Error, False)
            End Try
            Return myResult
