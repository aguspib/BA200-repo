...
Namespace Biosystems.Ax00.Global
    ...
    Public Class AlarmEnumerates        
        ...
        ''' </summary>
        ''' <remarks>
        ''' The number of this alarms is not associated, have to associate each time as you need.
        ''' </remarks>
        Public Enum Alarms
            ...
            INST_REJECTED_ERR               'ERROR! Instruction Rejected by a previous Error (Permanent or Self-recover like covers) (Stand by-Running) (FW ERROR CODE: 20) 'AG 12/03/2012
            INST_ABORTED_ERR                'ERROR! Fw indicates Instruction Aborted by an Error (Stand by-Running) (FW ERROR CODE: 21) 'AG 01/03/2012
            RECOVER_ERR                     'ERROR! Fw indicates Recover Failed (FW ERROR CODE: 22) 'AG 01/03/2012
            INST_REJECTED_WARN              'WARNING! Fw indicates Impossible to perform TEST/PTEST/WRUN; Wait to next Cycle (FW ERROR CODE: 28) 'AG 01/03/2012
            PH_BOARD_ERR                    'ERROR! Fw indicates not photometric board detected (FW ERROR CODE: 530) 'AG 01/03/2012
            GLF_RESET_ERR                   'ERROR! Fw indicates photometric board reset (FW ERROR CODE: 599) 'AG 01/03/2012
            SFX_RESET_ERR                   'ERROR! Fw indicates fluid system board reset (FW ERROR CODE: 699) 'AG 01/03/2012
            JEX_RESET_ERR                   'ERROR! Fw indicates manifold board reset (FW ERROR CODE: 799) 'AG 01/03/2012

            R1_BOARD_ERR                    'R1 board not responding                | FW ERROR CODE: 108 | DL 13/06/2012
            R1_RESET_ERR                    'R1 board reset                         | FW ERROR CODE: 109 | DL 13/06/2012
            R2_BOARD_ERR                    'R2 board not responding                | FW ERROR CODE: 118 | DL 13/06/2012
            R2_RESET_ERR                    'R2 board reset                         | FW ERROR CODE: 119 | DL 13/06/2012
            S_BOARD_ERR                     'Samples arm board not responding       | FW ERROR CODE: 128 | DL 13/06/2012
            S_RESET_ERR                     'Samples arm board reset                | FW ERROR CODE: 129 | DL 13/06/2012
            STIRRER1_BOARD_ERR              'Stirrer1 board not responding          | FW ERROR CODE: 138 | DL 13/06/2012
            STIRRER1_RESET_ERR              'Stirrer1 board reset                   | FW ERROR CODE: 139 | DL 13/06/2012
            STIRRER2_BOARD_ERR              'Stirrer2 board not responding          | FW ERROR CODE: 148 | DL 13/06/2012
            STIRRER2_RESET_ERR              'Stirrer2 board reset                   | FW ERROR CODE: 149 | DL 13/06/2012
            R1_DETECT_BOARD_ERR             'R1 detection board not responding      | FW ERROR CODE: 208 | DL 13/06/2012
            R1_DETECT_RESET_ERR             'R1 detection board reset               | FW ERROR CODE: 209 | DL 13/06/2012
            R2_DETECT_BOARD_ERR             'R2 detection board not responding      | FW ERROR CODE: 218 | DL 13/06/2012
            R2_DETECT_RESET_ERR             'R2 detection board reset               | FW ERROR CODE: 219 | DL 13/06/2012
            S_DETECT_BOARD_ERR              'Samples detection board not responding | FW ERROR CODE: 228 | DL 13/06/2012
            S_DETECT_RESET_ERR              'Samples detection board reset          | FW ERROR CODE: 229 | DL 13/06/2012
            FRIDGE_BOARD_ERR                'Reagents rotor board not responding    | FW ERROR CODE: 348 | DL 13/06/2012
            FRIDGE_RESET_ERR                'Reagents rotor board reset             | FW ERROR CODE: 349 | DL 13/06/2012
            S_ROTOR_BOARD_ERR               'Samples rotor board not responding     | FW ERROR CODE: 398 | DL 13/06/2012
            S_ROTOR_RESET_ERR               'Samples rotor board reset              | FW ERROR CODE: 399 | DL 13/06/2012
            GLF_BOARD_ERR                   'Photometric board not responding       | FW ERROR CODE: 598 | DL 13/06/2012
            SFX_BOARD_ERR                   'Fluid system board not responding      | FW ERROR CODE: 698 | DL 13/06/2012
            JEX_BOARD_ERR                   'Manifold board not responding          | FW ERROR CODE: 798 | DL 13/06/2012
            ...
            'ANALYZER ENTERS/LEAVES PAUSE MODE
            WS_PAUSE_MODE_WARN
