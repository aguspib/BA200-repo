...
#Region "Declarations"
    ...
    ' Movements
    'Private DirectMovPolar As Single
    'Private DirectMovZ As Single
    'Private DirectMovRotor As Single
    'Private StepMovPolar As Single
    'Private StepMovZ As Single
    'Private StepMovRotor As Single
    ...
    Private Property OpticCenteringModified() As Boolean
        ...
        Set(ByVal value As Boolean)
            If value Then
                ...
                Me.BsGridMixer2.SetAllRowDataInvalidated()
...
#Region "Arms Position Private Methods"
    ...
    Private Function PrepareTabsArms() As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareTabsArms ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Function PrepareArmTab(ByVal pBsGrid As BSGridControl) As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myResultData.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myResultData.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareArmTab ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub ActivateCheckButtons(ByVal pValue As Boolean)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ActivateCheckButtons ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub ActivateRowCells(ByVal pRowIndex As Integer, ByVal pValue As Boolean)
        Try
            ...
            End Select
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ActivateRowCells ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub DeactivateUnusedRowCells(ByVal pRowIndex As Integer)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".DeactivateUnusedRowCells ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub DeactivateUnusedAdjustControls()
        ...
        Try
            ...
            End With
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".DeactivateUnusedAdjustControls ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub ActivateCheckButton(ByVal pRowIndex As Integer, ByVal pValue As Boolean)
        Try
            ...
            End Select
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ActivateCheckButton ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub ShowIconValidate(ByVal pRowIndex As Integer, ByVal pValue As Boolean)
        Try
            ...
            End Select
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ShowIconValidate ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub GoToNextWizardMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".GoToNextWizardMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareStirrerButton(ByRef pButton As BSButton)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareStirrerButton ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareStirrerTestMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareStirrerTestMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareStirrerTestingMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareStirrerTestingMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareStirrerTestedMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareStirrerTestedMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
...
#Region "optic Centering Private Methods"
    ...
    Private Sub CalculateDistances()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Name & ".CalculateDistances", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".CalculateDistances", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    ...
    Private Function CreateChartDataCounts() As DataTable
        ...
        Catch ex As Exception
            Return Nothing
            MyBase.CreateLogActivity(ex.Message, Name & ".CreateChartDataCounts", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".CreateChartDataCounts", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Function
    ...
    Private Function CreateChartDataEncoder() As DataTable
        Try
            ...
            Dim i As Integer
            Dim value As Single
            'Dim localizeTransition As Boolean
            ...
            For Each A As Single In EncoderData
                ...
                If A = 0 Then
                    value = A
                    'localizeTransition = True
                Else
                    'If localizeTransition Then
                    '    EncoderTransitions.Add(i)
                    'End If
                    'localizeTransition = False
        ...
        Catch ex As Exception
            Return Nothing
            MyBase.CreateLogActivity(ex.Message, Name & ".CreateChartDataEncoder", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".CreateChartDataEncoder", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Function
    ...
    Private Sub InitializeChart()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Name & ".InitializeChart", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".InitializeChart", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
...
#Region "Generic Private Methods"
            ...
            Select Case MyBase.CurrentMode
                ...
                Case ADJUSTMENT_MODES.ADJUSTMENTS_READED
                    ...
                    If Me.SelectedPage = ADJUSTMENT_PAGES.NONE Then
                        ...
                        dialogResultToReturn = MyBase.ShowMessage(GetMessageText(GlobalEnumerates.Messages.SRV_ADJUSTMENTS_TESTS.ToString), Messages.SRV_OPTIC_ADJUSTMENT_ENTER.ToString)

                    End If

                    If Me.SelectedPage = ADJUSTMENT_PAGES.OPTIC_CENTERING Then
                        'MyBase.CurrentMode = ADJUSTMENT_MODES.LOADING
    ...
    Private Sub PrepareStirrerButtonAvailability()
        Try
            ...
            End If
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareStirrerButtonAvailability ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareLoadingMode()
        ...
        Try
            ...
            'me.LEDCurrentStep = GlobalBase.OpticalCenteringStepLed
            ...
            If Me.SelectedPage = ADJUSTMENT_PAGES.ARM_POSITIONS Then
                ...
                'PreparePage(Me.SelectedPage)

            End If

            Me.ChangedValue = False

            'myResultData = PrepareTabArm()
    ...
    Private Sub PrepareLoadedMode()
        ...
        Try
            InitializeAdjustControls()
            DefineScreenLayout(MyClass.SelectedPage)
            'ActivateAdjustButtons(True)

            'LoadAdjustmentGroupData() 'SGM 28/01/11
            ...
            Select Case Me.SelectedPage
                ...
                Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                    ...
                    'Me.BsChartPictureBox1.Visible = True
                    'Me.BsChartPictureBox2.Visible = False
            ...
            'SGM 29/02/2012
            If Me.WaitForScriptsExitingScreen Then
                If Not MyBase.SimulationMode Then System.Threading.Thread.Sleep(2000)
                Me.FinishExitScreen()
            End If
        ...
        Try
            ...
            Select Case Me.SelectedPage
                Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                    ...
                    'initialize absorbance data
                    'Me.ScannedAbsorbanceSteps = 0
                    Me.AbsorbanceData = New List(Of Single)

                    'If Not MyBase.SimulationMode Then
                    '    SendFwScript(ADJUSTMENT_MODES.ADJUST_PREPARING, ADJUSTMENT_GROUPS.PHOTOMETRY)
                    'End If
    ...
    Private Sub PrepareAbsorbanceScanningMode()
        Try
            ...
            If MyBase.SimulationMode Then
                ...
                MyBase.myServiceMDI.Focus()
                'MyBase.DisplaySimulationMessage("Reading Absorbance data from Instrument...")
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareAbsorbanceScanningMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareAbsorbanceScannedMode()
        Try
            ...
            If Me.myScreenDelegate.AbsorbanceScanDone Then
                ...
                If MyBase.SimulationMode Then
                    ' simulating
                    'MyBase.myServiceMDI.ErrorStatusLabel.Text = "Absorbance preparing ..."
            ...
            Else
                ...
                If MyBase.SimulationMode Then
                    ' simulating
                    'MyBase.myServiceMDI.ErrorStatusLabel.Text = "Absorbance readings ..."
                    MyBase.CurrentMode = ADJUSTMENT_MODES.ABSORBANCE_SCANNED
                    MyBase.ActivateMDIMenusButtons(True) 'SGM 28/09/2011
                    Me.PrepareArea()
                Else
    ...
    Private Sub PrepareAbsorbancePreparedMode()
        Try
            ...
            If MyBase.SimulationMode Then
                ...
                MyBase.myServiceMDI.Focus()
                'MyBase.DisplaySimulationMessage("Absorbance data received")
                ...
                If Not myGlobal.HasError And myGlobal.SetDatos IsNot Nothing Then
                    ...
                    'MyBase.DisplayMessage(Messages.SRV_ADJUSTMENTS_READY.ToString)
                    'MyBase.DisplaySimulationMessage("Optic Centering ready for adjusting")
            ...
            'MyBase.myScreenLayout.ButtonsPanel.SaveButton.Enabled = True     ' XBC 05/01/2012 - Add Encoder functionality (this functionality is treated inside CalculateDistances function)
            MyBase.myScreenLayout.ButtonsPanel.CancelButton.Enabled = True
            MyBase.myScreenLayout.ButtonsPanel.AdjustButton.Enabled = False
            MyBase.myScreenLayout.ButtonsPanel.ExitButton.Enabled = True
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareAbsorbancePreparedMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub FillAbsorbanceDataWithEmptyValues()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".FillAbsorbanceDataWithEmptyValues ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareAdjustPreparedMode()
        ...
        Try
            ...
            Select Case Me.SelectedPage
                Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                    ...
                    If MyBase.SimulationMode Then
                        ...
                        myGlobal = SimulateAbsorbanceData()
                ...
                Case ADJUSTMENT_PAGES.WASHING_STATION
                    ...
                    'myOffsetZ = myScreenDelegate.WashingStationOffset
                    ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    With Me.EditedValue
                        ...
                        ' XBC 18/04/2012 - Z aproximation is anuled
                        '.LastZValue = CSng(BsWashingAdjustmentLabel.Text) + myOffsetZ   ' CSng(ReadSpecificAdjustmentData(GlobalEnumerates.AXIS.Z).Value) 
                        .LastZValue = -100
                        ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    Select Case Me.SelectedArmTab
                        Case ADJUSTMENT_ARMS.SAMPLE
                            ...
                            If firstAvailableParam > -1 Then
                                ...
                                Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(firstAvailableParam + 3, SelectedRow)
            ...
            'If Me.SelectedPage <> ADJUSTMENT_PAGES.OPTIC_CENTERING Then
            '    If Me.SelectedPage = ADJUSTMENT_PAGES.WASHING_STATION Then MyBase.myScreenLayout.ButtonsPanel.SaveButton.Enabled = True
            '    MyBase.myScreenLayout.ButtonsPanel.CancelButton.Enabled = True
            '    MyBase.myScreenLayout.ButtonsPanel.AdjustButton.Enabled = False
            '    MyBase.myScreenLayout.ButtonsPanel.ExitButton.Enabled = True
    ...
    Private Function PrepareEditedValueForAdjusting() As Integer
            ...
            With Me.EditedValue
                Select Case Me.SelectedArmTab
                    Case ADJUSTMENT_ARMS.SAMPLE
                        ...
                        'myOffsetZ = myScreenDelegate.SampleArmOffset

                        '' XBC 11/10/2011
                        'If .AdjustmentID = ADJUSTMENT_GROUPS.SAMPLES_ARM_ZREF Or _
                        '   .AdjustmentID = ADJUSTMENT_GROUPS.SAMPLES_ARM_PARK Then
                        '    myOffsetZ = 0
                        'End If
                        '' XBC 11/10/2011
                        ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    Case ADJUSTMENT_ARMS.REAGENT1
                        ...
                        'myOffsetZ = myScreenDelegate.Reagent1ArmOffset

                        '' XBC 11/10/2011
                        'If .AdjustmentID = ADJUSTMENT_GROUPS.REAGENT1_ARM_ZREF Or _
                        '   .AdjustmentID = ADJUSTMENT_GROUPS.REAGENT1_ARM_PARK Then
                        '    myOffsetZ = 0
                        'End If
                        '' XBC 11/10/2011
                        ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    Case ADJUSTMENT_ARMS.REAGENT2
                        ...
                        'myOffsetZ = myScreenDelegate.Reagent2ArmOffset

                        '' XBC 11/10/2011
                        'If .AdjustmentID = ADJUSTMENT_GROUPS.REAGENT2_ARM_ZREF Or _
                        '   .AdjustmentID = ADJUSTMENT_GROUPS.REAGENT2_ARM_PARK Then
                        '    myOffsetZ = 0
                        'End If
                        '' XBC 11/10/2011
                        ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    Case ADJUSTMENT_ARMS.MIXER1
                        ...
                        'myOffsetZ = myScreenDelegate.Mixer1ArmOffset

                        '' XBC 11/10/2011
                        'If .AdjustmentID = ADJUSTMENT_GROUPS.MIXER1_ARM_ZREF Or _
                        '   .AdjustmentID = ADJUSTMENT_GROUPS.MIXER1_ARM_PARK Then
                        '    myOffsetZ = 0
                        'End If
                        '' XBC 11/10/2011
                        ' XBC 18/04/2012 - Z aproximation is anuled
                    ...
                    Case ADJUSTMENT_ARMS.MIXER2
                        ...
                        'myOffsetZ = myScreenDelegate.Mixer2ArmOffset

                        '' XBC 11/10/2011
                        'If .AdjustmentID = ADJUSTMENT_GROUPS.MIXER2_ARM_ZREF Or _
                        '   .AdjustmentID = ADJUSTMENT_GROUPS.MIXER2_ARM_PARK Then
                        '    myOffsetZ = 0
                        'End If
                        '' XBC 11/10/2011
                        ' XBC 18/04/2012 - Z aproximation is anuled
                ...
                If BsGridTemp.RowsCount > 0 Then
                    ...
                    If ReadSpecificAdjustmentData(GlobalEnumerates.AXIS.Z).CanMove Then
                        ...
                        If BsGridTemp.ParameterCellValue(SelectedRow, Z_COLUMN).Length > 0 Then
                            ' XBC 18/04/2012 - Z aproximation is anuled
                            '.LastZValue = CSng(BsGridTemp.ParameterCellValue(SelectedRow, Z_COLUMN)) + myOffsetZ
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareEditedValueForAdjusting ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub SetEditedValueHomeIDs()
        Try
            ...
            End With
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".SetEditedValueHomeIDs ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            ...
            Select Case Me.SelectedPage
                ...
                Case ADJUSTMENT_PAGES.ARM_POSITIONS
                    Select Case Me.SelectedArmTab
                        Case ADJUSTMENT_ARMS.SAMPLE
                            Dim send As Object = Nothing
                            Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(selectedColumn + 3, SelectedRow)
                            Me.BsGridSample.CellClick(send, myCellEventArgs)
                        Case ADJUSTMENT_ARMS.REAGENT1
                            Dim send As Object = Nothing
                            Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(selectedColumn + 3, SelectedRow)
    ...
    Private Sub PrepareAdjustExitingMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareAdjustExitingMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
        ...
        Try
            ...
            If Me.SelectedPage = ADJUSTMENT_PAGES.OPTIC_CENTERING Or Me.SelectedPage = ADJUSTMENT_PAGES.WASHING_STATION Then
                If MyBase.SimulationMode Then
                    ...
                    ''MyBase.DisplaySimulationMessage("Saving adjustments...")
                    'Me.PrepareArea()
                    ...
                    MyBase.DisplayMessage(Messages.SRV_ADJUSTMENTS_SAVED.ToString)
                    'MyBase.DisplaySimulationMessage("Adjustments successfully saved")
        ...
        Try
            ...
            If myScreenDelegate.LoadAdjDone And Not myScreenDelegate.ParkDone Then
                ...
                Else
                    ...
                    If MyBase.SimulationMode Then
                        ' simulating
                        'MyBase.DisplaySimulationMessage("Saving...")
                        Me.Cursor = Cursors.WaitCursor
                        System.Threading.Thread.Sleep(SimulationProcessTime)
                        MyBase.myServiceMDI.Focus()
                        Me.Cursor = Cursors.Default
            ...
            ElseIf myScreenDelegate.ParkDone Then
                    ...
                    Select Case Me.SelectedPage
                        Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                            If .canSaveRotorValue Then
                                ...
                                'Me.BsOpticTestButton.Enabled = True
                        ...
                        Case ADJUSTMENT_PAGES.WASHING_STATION
                            ...
                            If .canSaveZValue Then
                                ...
                                'Me.BsWashingTestButton.Enabled = True
                ...
                If Me.SelectedPage = ADJUSTMENT_PAGES.ARM_POSITIONS Then
                    Me.BsArmsOkButton.Enabled = False
                    'Me.BsArmsCancelButton.Enabled = MyClass.IsLocallySaved
                    Me.BsSaveButton.Enabled = MyClass.IsLocallySaved
    ...
    Private Sub PrepareTestExitingMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareTestExitingMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareTestExitedMode()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PrepareTestExitedMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub PrepareButtons()
        ...
        Try
            ...
            'MyBase.SetButtonImage(BsOpticAdjustButton, "ADJUSTMENT")
            'MyBase.SetButtonImage(BsOpticCancelButton, "UNDO")
            'MyBase.SetButtonImage(BsWSAdjustButton, "ADJUSTMENT")
            'MyBase.SetButtonImage(BsWSCancelButton, "UNDO")
            'MyBase.SetButtonImage(BsSaveButton, "SAVE")
            'MyBase.SetButtonImage(BsExitButton, "CANCEL")
            'MyBase.SetButtonImage(BsOpticStopButton, "STOP", 24, 24)
            'MyBase.SetButtonImage(BsArmsOkButton, "ACCEPT1")
            'MyBase.SetButtonImage(BsArmsCancelButton, "UNDO")
            'MyBase.SetButtonImage(BsStirrer1Button, "ESPIRAL")
            'MyBase.SetButtonImage(BsStirrer2Button, "ESPIRAL")
            'MyBase.SetButtonImage(BsUpDownWSButton1, "UPDOWN", 20, 20)
            'MyBase.SetButtonImage(BsUpDownWSButton2, "UPDOWN", 20, 20)
            'MyBase.SetButtonImage(BsUpDownWSButton3, "UPDOWN", 20, 20)
            ...
            '    'Me.BsGridMixer1.AdjustButtonImage = myImage
            '    'Me.BsGridMixer2.AdjustButtonImage = myImage
            'End If
            ''end SGM 28/02/2012
            ...
            '    Else
            '        myMixerImage = CType(myImage, Bitmap)
            '    End If

            '    Me.BsStirrer1Button.Image = myMixerImage
            '    'Me.BsStirrer1Button.BackgroundImageLayout = ImageLayout.Center
            '    Me.BsStirrer2Button.Image = myMixerImage
            '    'Me.BsStirrer2Button.BackgroundImageLayout = ImageLayout.Center
            'End If
    ...
    Private Function GetControlsLimits(ByVal pLimitsID As FieldLimitsEnum) As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            MyBase.CreateLogActivity(ex.Message, Me.Name & " GetControlsLimits ", EventLogEntryType.Error, _
                                                            GetApplicationInfoSession().ActivateSystemLog)
            'Show error message
            ...
            Select Case Me.SelectedPage
                Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                    ...
                    If (Not myGlobalDataTO.HasError And Not myGlobalDataTO.SetDatos Is Nothing) Then
                        ...
                        Me.BsLEDCurrentTrackBar.LargeChange = GlobalBase.OpticalCenteringStepLed
                ...
                Case ADJUSTMENT_PAGES.WASHING_STATION
                    ...
                    If (Not myGlobalDataTO.HasError And Not myGlobalDataTO.SetDatos Is Nothing) Then
                        ...
                        'Me.BsAdjustWashing.UnitsCaption = ""
    ...
    Private Function PreparePage() As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myResultData.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myResultData.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".PreparePage ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub CancelAdjustment()
        ...
        Try
            ...
            Else
                ...
                If MyBase.SimulationMode Then
                    ' simulating
                    'MyBase.DisplaySimulationMessage("Canceling changes...")
                    MyBase.CurrentMode = ADJUSTMENT_MODES.LOADED
                    PrepareArea()
                Else
    ...
    Private Sub FillAdjustmentValues()
        Try
            ...
            If Not Me.BsGridSample Is Nothing Then
                If Me.BsGridSample.RowsCount > 0 Then
                    ...
                    Me.BsGridSample.ParameterCellValue(0, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_DISP1.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(0, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_DISP1.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' DISP2
                    Me.BsGridSample.ParameterCellValue(1, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_DISP2.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(1, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_DISP2.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(1, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_DISP2.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' Z REFERENCE
                    Me.BsGridSample.ParameterCellValue(2, POLAR_COLUMN) = myScreenDelegate.SampleArmPolarZREF.ToString ' ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_ZREF.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(2, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_ZREF.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(2, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_ZREF.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' WASHING
                    Me.BsGridSample.ParameterCellValue(3, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_WASH.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(3, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_WASH.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(3, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_WASH.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' SAMPLE RING1 PEDIATRIC
                    Me.BsGridSample.ParameterCellValue(4, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING1.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(4, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING1.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(4, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING1.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' SAMPLE RING2 PEDIATRIC
                    Me.BsGridSample.ParameterCellValue(5, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING2.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(5, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING2.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(5, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING2.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' SAMPLE RING3 PEDIATRIC
                    Me.BsGridSample.ParameterCellValue(6, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING3.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    Me.BsGridSample.ParameterCellValue(6, Z_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING3.ToString, GlobalEnumerates.AXIS.Z).Value
                    Me.BsGridSample.ParameterCellValue(6, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING3.ToString, GlobalEnumerates.AXIS.ROTOR).Value


                    'SGM 29/02/2012
                    'Polar and Rotor values taken from Ring1
                    '' Z TUBE 
                    Me.BsGridSample.ParameterCellValue(7, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING1.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    ...
                    Me.BsGridSample.ParameterCellValue(7, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_RING1.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    ...
                    Me.BsGridSample.ParameterCellValue(8, ROTOR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_ISE.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    '' PARKING
                    Me.BsGridSample.ParameterCellValue(9, POLAR_COLUMN) = ReadGlobalAdjustmentData(ADJUSTMENT_GROUPS.SAMPLES_ARM_PARK.ToString, GlobalEnumerates.AXIS.POLAR).Value
            ...
            If Not Me.BsGridMixer2 Is Nothing Then
                If Me.BsGridMixer2.RowsCount > 0 Then
                    'For i As Integer = 0 To Me.BsGridMixer2.RowsCount - 1
                    '    Me.BsGridMixer2.ParameterCellValue(i, POLAR_COLUMN) = ReadGlobalAdjustmentData(Me.SelectedAdjustment.ToString, GlobalEnumerates.AXIS.POLAR).Value
                    '    Me.BsGridMixer2.ParameterCellValue(i, Z_COLUMN) = ReadGlobalAdjustmentData(Me.SelectedAdjustment.ToString, GlobalEnumerates.AXIS.Z).Value
                    '    Me.BsGridMixer2.ParameterCellValue(i, ROTOR_COLUMN) = ReadGlobalAdjustmentData(Me.SelectedAdjustment.ToString, GlobalEnumerates.AXIS.ROTOR).Value
                    'Next
                    '' DISP1
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".FillAdjustmentValues ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub FillAdjustmentValuesintoDelegate()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".FillAdjustmentValuesintoDelegate ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub DisableButtons()
        Try
            ...
            '    Me.BsOpticCancelButton.Enabled = False
            '    Me.BsExitButton.Enabled = False
            '    Me.BsOpticStopButton.Enabled = False   ' XBC 05/12/2011
            'End If
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".DisableButtons ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub DisableAll()
        Try
            ...
            ' XBC 28/03/2012 - provoca parpadeo - se emplaza en cada Case con tratamiento específico
            'MyBase.ActivateMDIMenusButtons(False) 'SGM 28/09/2011
        ...
        Try
            Select Case SelectedPage
                ...
                Case ADJUSTMENT_PAGES.ARM_POSITIONS
                    ...
                    'Me.BsAdjustPolar.CurrentValue = 0  SGM 24/01/11
                    'Me.BsAdjustZ.CurrentValue = 0  SGM 24/01/11
                    'Me.BsAdjustRotor.CurrentValue = 0  SGM 24/01/11
    ...
    Private Sub ActivateAdjustButtons(ByVal pValue As Boolean)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ActivateAdjustButtons ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub InitializeEditedValue()
        Try
            ...
            End With
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".InitializeEditedValue ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub MoveAbsorbanceChartWells(ByVal pSteps As Integer)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".MoveAbsorbanceChartWells", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub FinishExitScreen()
        ...
        Try
            ...
            If Not WashingStationValidated Or Not AllArmsPositionsValidated Then
                ...
                If dialogResultToReturn = Windows.Forms.DialogResult.Yes Then
                    MyBase.CreateLogActivity("Leaving screen without complete Adjustment decided by user...", Me.Name & ".ExitScreen", EventLogEntryType.Information, False)
                    ExitScreen = True
...
#Region "Generic Adjusments DS Methods"
    ...
    Private Function UpdateLocalSavedSpecificAdjustmentsDS(ByVal pCodew As String, ByVal pValue As String) As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myGlobal.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myGlobal.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".UpdateLocalSavedSpecificAdjustmentsDS ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Function UpdateLocalSavedAdjustmentsDS() As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myGlobal.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myGlobal.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".UpdateLocalSavedAdjustmentsDS ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub AddToLocalSavedAdjustmentsDS(ByVal pNewAdjustmentsDS As SRVAdjustmentsDS)
            ...
            If MyClass.LocalSavedAdjustmentsDS IsNot Nothing AndAlso pNewAdjustmentsDS IsNot Nothing Then
                For Each dr2 As SRVAdjustmentsDS.srv_tfmwAdjustmentsRow In pNewAdjustmentsDS.srv_tfmwAdjustments.Rows
                    ...
                    For Each dr1 As SRVAdjustmentsDS.srv_tfmwAdjustmentsRow In MyClass.LocalSavedAdjustmentsDS.srv_tfmwAdjustments.Rows
                        'If dr1.CodeFw.Trim.ToUpper = dr2.CodeFw.Trim.ToUpper Then
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".AddToLocalSavedAdjustmentsDS ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Public Function SetAdditionalAdjustments(ByVal pAdjustmentsDS As SRVAdjustmentsDS) As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myGlobal.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myGlobal.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".SetAdditionalAdjustments ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Function LoadAllArmsPositionsAdjustmentData() As GlobalDataTO
        ...
        Catch ex As Exception
            Me.SelectedAdjustmentsDS = CopyOfSelectedAdjustmentsDS
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".LoadAllArmsAdjustmentData ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
                ...
                Select Case Me.SelectedPage
                    ...
                    Case ADJUSTMENT_PAGES.ARM_POSITIONS
                        ...
                        Else
                            ...
                            ' XBC 24/11/2011
                            'If .HistoryArea = PositionsAdjustmentDelegate.HISTORY_AREAS.NONE Or .HistoryArea = PositionsAdjustmentDelegate.HISTORY_AREAS.MIX1_TEST Or .HistoryArea = PositionsAdjustmentDelegate.HISTORY_AREAS.MIX2_TEST Then Exit Sub
    ...
    Private Sub ReportHistoryArmPositions(ByVal pTask As HISTORY_TASKS, _
        ...
        Try
            With Me.myScreenDelegate
                ...
                '                    Where a.GroupID.Trim.ToUpper.EndsWith(myGroup) _
                '                    And a.CanSave = True _
                '                    Select a).ToList
                myNewAdjustments = (From a As SRVAdjustmentsDS.srv_tfmwAdjustmentsRow _
                    In pNewAxesValues.srv_tfmwAdjustments _
                ...
                For Each R As SRVAdjustmentsDS.srv_tfmwAdjustmentsRow In myAllAdjustments
                    ...
                    'If myGroupID <> R.GroupID.ToUpper.Trim Then
                    ...
                    'myGroupID = R.GroupID.ToUpper.Trim
                    ...
                    For Each N As SRVAdjustmentsDS.srv_tfmwAdjustmentsRow In myNewAdjustments
                        ...
                        ' XBC 22/11/2011
                        'If N.CanSave And R.CanSave Then
                        '    If R.GroupID.ToUpper.Trim = N.GroupID.ToUpper.Trim Then
                    ...
                    Else
                        ...
                        'If R.GroupID.Trim.ToUpper.Contains("_DISP1") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Dispensation
                        'If R.GroupID.Trim.ToUpper.Contains("_DISP2") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Predilution
                        'If R.GroupID.Trim.ToUpper.Contains("_ZREF") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Z_Ref
                        'If R.GroupID.Trim.ToUpper.Contains("_WASH") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Washing
                        'If R.GroupID.Trim.ToUpper.Contains("_RING1") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring1
                        'If R.GroupID.Trim.ToUpper.Contains("_RING2") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring2
                        'If R.GroupID.Trim.ToUpper.Contains("_RING3") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring3
                        'If R.GroupID.Trim.ToUpper.Contains("_ZTUBE1") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Z_Tube
                        'If R.GroupID.Trim.ToUpper.Contains("_ISE") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.ISE_Pos
                        'If R.GroupID.Trim.ToUpper.Contains("_PARK") Then myPosition = PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Parking
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".ReportHistoryArmPositions ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
                ...
                Select Case pArea
                    ...
                    Case Else
                        ...
                        If pIsLastArmAction Then
                            ...
                            ' XBC 24/11/2011
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Dispensation, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Predilution, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Z_Ref, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Washing, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring1, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring2, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Ring3, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Z_Tube, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.ISE_Pos, myAxesValues)
                            '.HisArmAxesValues.Add(PositionsAdjustmentDelegate.HISTORY_ARM_POSITIONS.Parking, myAxesValues)
                            ' XBC 24/11/2011
                        End If
...
#Region "Simulation Methods"
    ...
    Private Function SimulateAbsorbanceData() As GlobalDataTO
        ...
        Try
            ...
            For a As Integer = 1 To 400 Step 1
                ...
                '    MyBase.CreateLogActivity(AbsorbanceData(AbsorbanceData.Count - 1).ToString, Name & ".SimulateAbsorbanceData", EventLogEntryType.Information, GetApplicationInfoSession().ActivateSystemLog)
                '    'MyBase.CreateLogActivity(AbsorbanceData(AbsorbanceData.Count - 1).ToString, Name & ".SimulateAbsorbanceData", EventLogEntryType.Information, GetApplicationInfoSession().ActivateSystemLog)
                '    'MyBase.CreateLogActivity(AbsorbanceData(AbsorbanceData.Count - 1).ToString, Name & ".SimulateAbsorbanceData", EventLogEntryType.Information, GetApplicationInfoSession().ActivateSystemLog)
                '    'MyBase.CreateLogActivity(AbsorbanceData(AbsorbanceData.Count - 1).ToString, Name & ".SimulateAbsorbanceData", EventLogEntryType.Information, GetApplicationInfoSession().ActivateSystemLog)
                'End If
        ...
        Catch ex As Exception
            ...
            myGlobal.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myGlobal.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Name & ".SimulateAbsorbanceData", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".SimulateAbsorbanceData", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    ...
    Private Sub SimulateRELPositioning()
        Try
            ...
            'MyBase.DisplaySimulationMessage("Performing step positioning...")
            PrepareArea()
            ...
            MyBase.DisplayMessage(Messages.SRV_COMPLETED.ToString)
            'MyBase.DisplaySimulationMessage("Action completed...")
    ...
    Private Sub SimulateABSPositioning()
        Try
            ...
            MyBase.CurrentMode = ADJUSTMENT_MODES.ADJUSTING
            'MyBase.DisplaySimulationMessage("Performing absolute positioning...")
            PrepareArea()
    ...
    Private Sub SimulateHOMEPositioning()
        Try
            ...
            MyBase.CurrentMode = ADJUSTMENT_MODES.ADJUSTING
            'MyBase.DisplaySimulationMessage("Performing home positioning...")
            PrepareArea()
    ...
    Private Function SimulateEncoderData() As GlobalDataTO
        ...
        Catch ex As Exception
            ...
            myGlobal.ErrorCode = GlobalEnumerates.Messages.SYSTEM_ERROR.ToString
            myGlobal.ErrorMessage = ex.Message
            MyBase.CreateLogActivity(ex.Message, Name & ".SimulateEncoderData", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Name & ".SimulateEncoderData", GlobalEnumerates.Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
        Return myGlobal
    End Function
...
#Region "Events"
    ...
    'SGM 08/03/11
    Private Sub PositionsAdjustments_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        Dim myGlobal As New GlobalDataTO
        Try
            ...
            Else
                ...
                If Not Me.myServiceMDI.AdjustmentsReaded Then
                    ...
                    If MyBase.SimulationMode Then
                        ...
                        PrepareArea()
                        MyBase.DisplayMessage(Messages.SRV_READ_ADJUSTMENTS.ToString)
                        'MyBase.DisplaySimulationMessage("Reading Adjustments from Instrument...")
                        ...
                        MyBase.DisplayMessage(Messages.SRV_ADJUSTMENTS_READED.ToString)
                        'MyBase.DisplaySimulationMessage("Adjustments readed")
    ...
    Private Sub BsTabArmsControl_Selecting(ByVal sender As Object, ByVal e As System.Windows.Forms.TabControlCancelEventArgs) Handles BsTabArmsControl.Selecting
        Try
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsTabArmsControl_Selecting ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsTabPagesControl_Selected(ByVal sender As Object, ByVal e As System.Windows.Forms.TabControlEventArgs) Handles BsTabPagesControl.Selected
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsTabArmsControl_Selected ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsTabPagesControl_Selecting(ByVal sender As Object, ByVal e As System.Windows.Forms.TabControlCancelEventArgs) Handles BsTabPagesControl.Selecting
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsTabControl1_Selecting ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub SelectedValueEvent(ByVal pRowIndex As Integer, ByVal pColIndex As Integer) Handles BsGridSample.SelectedValueEvent, _
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".SelectedValueEvent ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Function SetPositionAdjustmentType(ByVal pArm As ADJUSTMENT_ARMS, ByVal pRowIndex As Integer) As ADJUSTMENT_GROUPS
        ...
        Try
            ...
            End Select
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".SetPositionAdjustmentType ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustButtons_Click(ByVal adjButton As DataGridViewDisableButtonCell, ByVal pRowIndex As Integer) Handles BsGridSample.Button1Click, _
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustButton_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            ...
            If MyBase.CurrentMode = ADJUSTMENT_MODES.TESTED Then
                ...
                Else
                    ...
                    If Not myGlobal.HasError Then
                        If MyBase.SimulationMode Then
                            ' simulating
                            'MyBase.DisplaySimulationMessage("Exiting Test...")
                            Me.Cursor = Cursors.WaitCursor
                            System.Threading.Thread.Sleep(SimulationProcessTime)
                            MyBase.myServiceMDI.Focus()
                            Me.Cursor = Cursors.Default
                ...
                With EditedValue
                    Select Case Me.SelectedPage
                        Case ADJUSTMENT_PAGES.OPTIC_CENTERING
                            ...
                            'myScreenDelegate.WaveLength = me.WaveLength
                            'myScreenDelegate.NumWells = me.WellsToRead
                            'myScreenDelegate.StepsbyWell = me.StepsByWell
                    ...
                    Else
                        If MyBase.SimulationMode Then
                            ...
                            If Not Me.AllHomesAreDone Then
                                ...
                                'MyBase.DisplaySimulationMessage("Pending Homes successfully completed")
    ...
    Private Sub BsCancelButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsOpticCancelButton.Click, _
    ...
    Private Sub BsArmsOkButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsArmsOkButton.Click
        Try
            MyClass.IsLocallySavedAttr = True
            MyClass.SaveAdjustment()
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsArmsOkButton_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsArmsOkButton_Click ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsMixButtons_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsStirrer1Button.Click, BsStirrer2Button.Click
        Try
            'Dim myButton As BSButton = CType(sender, BSButton)

            ' XBC 05/10/2011
            'If MyBase.CurrentMode <> ADJUSTMENT_MODES.STIRRER_TEST And _
            'MyBase.CurrentMode <> ADJUSTMENT_MODES.STIRRER_TESTING Then
            If Not Me.IsStirrerTesting Then
                If MyBase.SimulationMode Then
                    ...
                    'MyBase.DisplaySimulationMessage("Testing mixer...")
                    Me.PrepareArea()
                Else
                    MyBase.CurrentMode = ADJUSTMENT_MODES.STIRRER_TEST
                    Me.PrepareArea()
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsMixButtons_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsUpDownWSButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsUpDownWSButton3.Click
        Try
            Me.SendWASH_STATION_CTRL()

        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsUpDownWSButton3_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    ''' <param name="e"></param>
    ''' <remarks>Created by XBC 30/11/2011</remarks>
    Private Sub BsStopButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsOpticStopButton.Click
        'Dim myGlobal As New GlobalDataTO
        Try
            Select Case Me.SelectedPage
                Case ADJUSTMENT_PAGES.OPTIC_CENTERING
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsStopButton_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsStopButton_Click ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsStopButton_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BsOpticStopButton.MouseHover
        Me.Cursor = Cursors.Default
    End Sub
    ...
    ''' <param name="e"></param>
    ''' <remarks>Created by XBC 30/11/2011</remarks>
    Private Sub BsStopButton_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles BsOpticStopButton.MouseMove
        Me.Cursor = Cursors.Default
    End Sub

    Private Sub AbsorbanceChart_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles AbsorbanceChart.Paint
        Try

        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".AbsorbanceChart_Paint ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".AbsorbanceChart_Paint ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub AbsorbanceChart_CustomPaint(ByVal sender As System.Object, ByVal e As DevExpress.XtraCharts.CustomPaintEventArgs) Handles AbsorbanceChart.CustomPaint
        Try
    ...
    Private Sub AbsorbanceChart_Zoom(ByVal sender As System.Object, ByVal e As DevExpress.XtraCharts.ChartZoomEventArgs) Handles AbsorbanceChart.Zoom
        Try
    ...
    Private Sub chartControl1_MouseMove(ByVal sender As Object, ByVal e As MouseEventArgs) Handles AbsorbanceChart.MouseMove
            ...
            If hi.Series IsNot Nothing AndAlso hi.Series.LegendText = Me.AbsorbanceChart.Series(0).LegendText Then
                ...
                If point IsNot Nothing Then
                    ...
                    If IsNumeric(point.Argument) And IsNumeric(EditedValue.LastRotorValue) And IsNumeric(myScreenDelegate.StepsbyWell) Then
                        ...
                        ' Show the tooltip.
                        ToolTipController1.ShowHint(argument & Constants.vbLf & values, myMultiLangResourcesDelegate.GetResourceText(Nothing, "LBL_SRV_SeriesPointData", currentLanguage))
                    End If
                Else
                    ' Hide the tooltip.
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".chartControl1_MouseMove ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub AbsorbanceChart_CustomDrawAxisLabel(ByVal sender As Object, ByVal e As CustomDrawAxisLabelEventArgs) Handles AbsorbanceChart.CustomDrawAxisLabel
        Try
            ...
            End If
        Catch ex As Exception
            CreateLogActivity(ex.Message, Me.Name & ".AbsorbanceChart.CustomDrawAxisLabel ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
        End Try
    End Sub
    ...
    Private Sub chartControl1_CustomDrawSeriesPoint(ByVal sender As Object, ByVal e As CustomDrawSeriesPointEventArgs) Handles AbsorbanceChart.CustomDrawSeriesPoint
        Try
            ...
            End If
        Catch ex As Exception
            CreateLogActivity(ex.Message, Me.Name & ".AbsorbanceChart.CustomDrawSeriesPoint ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
        End Try
    End Sub

    Private Sub BsAdjustControl_VisibleChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsAdjustPolar.VisibleChanged, _
        ...
        Try
            ...
            ElseIf Me.BsAdjustPolar.Visible Then
                ...
                'Else
                'Me.BsArmsCancelButton.Visible = False
            End If
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustControl_VisibleChanged ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
...
#Region "XPS Info Events"
    ...
    Private Sub BsXPSViewer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles BsInfoOptXPSViewer.Load, _
...
#Region "event handler overloads"
    ' SET ABSOLUTE POINT
    Private Sub BsAdjustOptic_SetABSPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustOptic.AbsoluteSetPointReleased
        Try
            ' XBC 04/01/2012 
            ...
            ' XBC 04/01/2012 
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_SetABSPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustOptic_SetABSPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustWashing_SetABSPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustWashing.AbsoluteSetPointReleased
        Try
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustWashing_SetABSPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustWashing_SetABSPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustPolar_SetABSPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustPolar.AbsoluteSetPointReleased
        Try
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_SetABSPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustPolar_SetABSPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustZ_SetABSPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustZ.AbsoluteSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.Z
            EditedValue.NewZValue = Value
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_SetABSPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustZ_SetABSPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustRotor_SetABSPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustRotor.AbsoluteSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.ROTOR
            EditedValue.NewRotorValue = Value
    ...
    ' SET RELATIVE POINT
    Private Sub BsAdjustOptic_SetRELPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustOptic.RelativeSetPointReleased
        Try
            ' XBC 29/10/2012
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_SetRELPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustOptic_SetRELPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustWashing_SetRELPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustWashing.RelativeSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.Z
            EditedValue.stepValue = Value
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustWashing_SetRELPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustWashing_SetRELPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustPolar_SetRELPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustPolar.RelativeSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.POLAR
            EditedValue.stepValue = Value
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_SetRELPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustPolar_SetRELPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustZ_SetRELPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustZ.RelativeSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.Z
            EditedValue.stepValue = Value
            EditedValue.NewZValue = EditedValue.CurrentZValue + Value
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_SetRELPointReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustZ_SetRELPointReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustRotor_SetRELPointReleased(ByVal sender As System.Object, ByVal Value As System.Single) Handles BsAdjustRotor.RelativeSetPointReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.ROTOR
            EditedValue.stepValue = Value
            EditedValue.NewRotorValue = EditedValue.CurrentRotorValue + Value
    ...
    Private Sub BsAdjustOptic_HomeRequestReleased(ByVal sender As System.Object) Handles BsAdjustOptic.HomeRequestReleased
        Try
            ...
            ' XBC 04/01/2012 
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_HomeRequestReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustOptic_HomeRequestReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustWashing_HomeRequestReleased(ByVal sender As System.Object) Handles BsAdjustWashing.HomeRequestReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.Z
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustWashing_HomeRequestReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustWashing_HomeRequestReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustPolar_HomeRequestReleased(ByVal sender As System.Object) Handles BsAdjustPolar.HomeRequestReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.POLAR
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_HomeRequestReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustPolar_HomeRequestReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustZ_HomeRequestReleased(ByVal sender As System.Object) Handles BsAdjustZ.HomeRequestReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.Z
            EditedValue.NewZValue = Me.HomeZ
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_HomeRequestReleased ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsAdjustZ_HomeRequestReleased ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub
    Private Sub BsAdjustRotor_HomeRequestReleased(ByVal sender As System.Object) Handles BsAdjustRotor.HomeRequestReleased
        Try
            EditedValue.AxisID = GlobalEnumerates.AXIS.ROTOR
    ...
    Private Sub BsAdjustOptic_SetPointOutOfRange(ByVal sender As Object) Handles BsAdjustOptic.SetPointOutOfRange
        Try
            MyBase.DisplayMessage(Messages.SRV_OUTOFRANGE.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_SetPointOutOfRange ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustWashing_SetPointOutOfRange(ByVal sender As Object) Handles BsAdjustWashing.SetPointOutOfRange
        Try
            MyBase.DisplayMessage(Messages.SRV_OUTOFRANGE.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustWashing_SetPointOutOfRange ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustPolar_SetPointOutOfRange(ByVal sender As Object) Handles BsAdjustPolar.SetPointOutOfRange
        Try
            MyBase.DisplayMessage(Messages.SRV_OUTOFRANGE.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_SetPointOutOfRange ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustZ_SetPointOutOfRange(ByVal sender As Object) Handles BsAdjustZ.SetPointOutOfRange
        Try
            MyBase.DisplayMessage(Messages.SRV_OUTOFRANGE.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_SetPointOutOfRange ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustOptic_ValidationError(ByVal sender As Object, ByVal Value As String) Handles BsAdjustOptic.ValidationError
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_ValidationError ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustWashing_ValidationError(ByVal sender As Object, ByVal Value As String) Handles BsAdjustWashing.ValidationError
        Try
            MyBase.DisplayMessage(Messages.FWSCRIPT_VALIDATION_ERROR.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustWashing_ValidationError ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustPolar_ValidationError(ByVal sender As Object, ByVal Value As String) Handles BsAdjustPolar.ValidationError
        Try
            MyBase.DisplayMessage(Messages.FWSCRIPT_VALIDATION_ERROR.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_ValidationError ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustZ_ValidationError(ByVal sender As Object, ByVal Value As String) Handles BsAdjustZ.ValidationError
        Try
            MyBase.DisplayMessage(Messages.FWSCRIPT_VALIDATION_ERROR.ToString)
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_ValidationError ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustOptic_FocusReceived(ByVal sender As Object) Handles BsAdjustOptic.FocusReceived
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustOptic_FocusReceived ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustPolar_FocusReceived(ByVal sender As Object) Handles BsAdjustPolar.FocusReceived
        Try
            ...
            Dim send As Object = Nothing
            Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(POLAR_COLUMN + 3, SelectedRow)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustPolar_FocusReceived ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustControl_OnEditionMode(ByVal sender As Object, ByVal pEditionMode As Boolean) Handles BsAdjustOptic.EditionModeChanged, _
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustControl_OnEditionMode ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustZ_FocusReceived(ByVal sender As Object) Handles BsAdjustZ.FocusReceived
        Try
            ...
            Dim send As Object = Nothing
            Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(Z_COLUMN + 3, SelectedRow)
            If Not FocusedFromGrid Then
                Select Case SelectedArmTab
                    Case ADJUSTMENT_ARMS.SAMPLE
                        Me.BsGridSample.CellClick(send, myCellEventArgs)
        ...
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsAdjustZ_FocusReceived ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
    ...
    Private Sub BsAdjustRotor_FocusReceived(ByVal sender As Object) Handles BsAdjustRotor.FocusReceived
        Try
            ...
            Dim send As Object = Nothing
            Dim myCellEventArgs As System.Windows.Forms.DataGridViewCellEventArgs = New System.Windows.Forms.DataGridViewCellEventArgs(ROTOR_COLUMN + 3, SelectedRow)
            If Not FocusedFromGrid Then
                Select Case SelectedArmTab
                    Case ADJUSTMENT_ARMS.SAMPLE
                        Me.BsGridSample.CellClick(send, myCellEventArgs)
...
#Region "LED Current"
    Private Sub LEDCurrentTrackBar_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsLEDCurrentTrackBar.ValueChanged
        Try
            Me.LEDCurrent = Me.BsLEDCurrentTrackBar.Value
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".LEDCurrentTrackBar_ValueChanged ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".LEDCurrentTrackBar_ValueChanged ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsPlusMinusLabel_EnabledChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BsPlusLabel.EnabledChanged, BsMinusLabel.EnabledChanged
        Try
            ...
            End If
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsPlusMinusLabels_MouseEnter ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsPlusMinusLabels_MouseEnter ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsPlusMinusLabels_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsMinusLabel.MouseEnter, BsPlusLabel.MouseEnter
        Try
    ...
    Private Sub BsPlusMinusLabels_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsMinusLabel.MouseLeave, BsPlusLabel.MouseLeave
        Try
            If BsLEDCurrentTrackBar.Enabled Then
                Dim myLabel As Label = CType(sender, Label)
                If myLabel IsNot Nothing Then
            ...
            End If
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsPlusMinusLabels_MouseLeave ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsPlusMinusLabels_MouseLeave ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsMinusLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsMinusLabel.Click
        Try
            ...
            End If
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsMinusLabel_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
            MyBase.ShowMessage(Me.Name & ".BsMinusLabel_Click ", Messages.SYSTEM_ERROR.ToString, ex.Message, Me)
        End Try
    End Sub

    Private Sub BsPlusLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BsPlusLabel.Click
        Try
            If BsLEDCurrentTrackBar.Enabled And BsLEDCurrentTrackBar.Value > 0 Then
            ...
            End If
        Catch ex As Exception
            MyBase.CreateLogActivity(ex.Message, Me.Name & ".BsPlusLabel_Click ", EventLogEntryType.Error, GetApplicationInfoSession().ActivateSystemLog)
...
#Region "TO DELETE"
    '' XBC 02/01/2012 - PROVES 
    'Private intprova As Integer

    ''Private Sub BsButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ''    DisplayIndicators()
    ''End Sub

    'Private Sub DisplayIndicators()
    '    If intprova = 0 Then
    '        AddIndicator(AbsorbanceChart.Series(0), FibonacciIndicatorKind.FibonacciArcs)
    '    ElseIf intprova = 1 Then
    '        AddIndicator(AbsorbanceChart.Series(0), FibonacciIndicatorKind.FibonacciFans)
    '    ElseIf intprova = 2 Then
    '        AddIndicator(AbsorbanceChart.Series(0), FibonacciIndicatorKind.FibonacciRetracement)
    '    Else
    '        intprova = 0
    '        AddIndicator(AbsorbanceChart.Series(0), FibonacciIndicatorKind.FibonacciArcs)
    '    End If
    ...
    '    Dim indicators As IndicatorCollection = (CType(ser.View, SplineSeriesView)).Indicators
    ...
    '        If kind = FibonacciIndicatorKind.FibonacciRetracement Then
    '            ' Add trendline
    '            ' Create and customize a trendline, 
    '            Dim trendline1 As New TrendLine("A Trend")
    '            trendline1.Point1.Argument = WellCenters(i)
    '            trendline1.Point1.ValueLevel = ValueLevel.High
    '            trendline1.Point2.Argument = EncoderTransitions(i)
    ...
    '            indicators.Add(trendline1)
    '        Else
    '            '' Add a new indicator to it.
    '            'indicators.Add(CreateIndicator(kind, _
    '            '                               WellCenters(i), _
    '            '                               EncoderTransitions(i), _
    '            '                               ValueLevel.High))
    '        End If
    ...
    'Private Function CreateIndicator(ByVal kind As FibonacciIndicatorKind, ByVal arg1 As Single, ByVal arg2 As Single, ByVal level As ValueLevel) As FibonacciIndicator
    ...
    '    fi.BaseLevelLineStyle.DashStyle = DashStyle.Solid
    ...
    'Private Sub BsSaveButton_EnabledChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BsSaveButton.EnabledChanged
