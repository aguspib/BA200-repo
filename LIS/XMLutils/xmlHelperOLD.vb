...
'AG 13/03/2013 Move to Global and rename the class in LIS project as xmlHelperOLD for not lose historical in SourceSafe
...
Namespace Biosystems.Ax00.LISCommunications
    ...
    Partial Public Class xmlHelperOLD
