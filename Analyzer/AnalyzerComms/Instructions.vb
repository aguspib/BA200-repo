                            ...
                            For Each myInstructionTO As InstructionParameterTO In myPreparationParameterList
                                ...
                                Select Case myInstructionTO.ParameterIndex
                                    Case 1 'Axxx Analyzer Description
                                        myInstructionTO.ParameterValue = AnalyzerManager.GetCurrentAnalyzerManager().Model ' "A400" '1st & 2on characters: model, 3th & 4th characters: analyzer number
                                        Exit Select
                ...
                For Each myInstructionTO As InstructionParameterTO In myWashInstruction
                    Select Case myInstructionTO.ParameterIndex
                        Case 1 'Analyzer Model and Number
                            myInstructionTO.ParameterValue = AnalyzerManager.GetCurrentAnalyzerManager().Model '"A400"
                            Exit Select
                        Case 2 'Instruction Code
...
#End Region
        ...
        Private Sub SetAnalyzerDescription(ByRef myPreparationParameterList As List(Of InstructionParameterTO), ByRef index As Integer)
            ...
            myInstructionTO.ParameterValue = AnalyzerManager.GetCurrentAnalyzerManager().Model
        End Sub
