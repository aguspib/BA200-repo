...
#Region "Properties"
        ...
        Event ISEMaintenanceRequired(ByVal pOperation As ISEManager.MaintenanceOperations)
        ...
        Property CurrentProcedure() As ISEManager.ISEProcedures
        ...
        ReadOnly Property LastProcedureResult() As ISEManager.ISEProcedureResult
        ...
        ReadOnly Property FirmwareErrDetected As Boolean

#End Region

#Region "Public Methods"

        Function AbortCurrentProcedureDueToException(Optional ByVal isTimeoutException As Boolean = False) As GlobalDataTO
        Function RefreshAllDatabaseInformation() As GlobalDataTO
        Function RefreshMonitorDataTO() As GlobalDataTO
        Function GetISEAlarmsForUtilities(ByRef pPendingCalibrations As List(Of ISEManager.MaintenanceOperations)) As GlobalDataTO
