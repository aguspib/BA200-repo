    ...
    Partial Public Class ExecutionsR1ResultsDelegate
        ...
        Public Function SaveResults(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "ExecutionsR1ResultsDelegate.SaveResults", EventLogEntryType.Error, False)
        ...
        Public Function ResetWS(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "ExecutionsR1ResultsDelegate.ResetWS", EventLogEntryType.Error, False)
