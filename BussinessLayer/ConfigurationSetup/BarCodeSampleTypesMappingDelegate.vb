...
#Region "Other Methods"
        ...
        Public Function ReadAll(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "BarCodeSampleTypesMappingDelegate.ReadAll", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function ReadByExternalSampleType(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pExternalSampleType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "BarCodeSampleTypesMappingDelegate.ReadByExternalSampleType", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function Update(ByVal pDBConnection As SqlConnection, ByVal pBarCodeSampleTypesMappingDS As BarCodeSampleTypesMappingDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "BarCodeSampleTypesMappingDelegate.Update", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
