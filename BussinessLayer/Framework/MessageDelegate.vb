...
#Region "Methods"
        ...
        Public Function GetMessageDescription(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pMsgID As String, _
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "MessageDelegate.GetMessageDescription", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function GetAllMessageDescription(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "MessageDelegate.GetAllMessageDescription", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) And (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
