...
#Region "Other Methods"
        ...
        Public Function GetAllBottles(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerModel As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "AnalyzerModelTubesByRingDelegate.GetAllBottles", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function GetAllTubes(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAnalyzerModel As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "AnalyzerModelTubesByRingDelegate.GetAllTubes", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) And (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
