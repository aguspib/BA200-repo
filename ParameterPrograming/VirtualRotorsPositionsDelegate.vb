                    ...
                    If (Not dbConnection Is Nothing) Then
                        ...
                        If pRotorType = "REAGENTS" Then
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: REAGENT with ReagentID = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: Bottle solution with SolutionCode = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
                        ...
                        Else
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: CALIBRATOR with CalibratorID = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: CONTROL with ControlID = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: PATIENT with PatientID = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
                            ...
                            If linqRes.Count > 0 Then
                                myLogAcciones.CreateLogActivity("Invalid values: Tube solution with SolutionCode = vbNULL " & textDetails, "VirtualRotorsPositionsDelegate.CheckForInvalidPosition", EventLogEntryType.Information, False)
                            End If
