...
#Region "Public Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestReagentsVolumeDS As TestReagentsVolumesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "TestReagentsVolumeDelegate.Create", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function DeleteByTestIDAndSampleType(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, ByVal pSampleType As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestReagentsVolumeDelegate.DeleteByTestIDAndSampleType", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function DeleteByTestIDReagNumberReagID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, ByVal pReagentNumber As Integer, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestReagentsVolumeDelegate.DeleteByTestIDReagNumberReagID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function GetReagentsVolumesByTestID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestReagentsVolumeDelegate.GetReagentsVolumesByTestID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function Update(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestReagentsVolumeDS As TestReagentsVolumesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestReagentsVolumeDelegate.Update", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
