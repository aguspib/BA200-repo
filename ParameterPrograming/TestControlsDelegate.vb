...
#Region "Public Methods"
        ...
        Public Function AddTestControlsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestControlDS As TestControlsDS, _
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.AddTestControls", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function CountActiveByTestIDAndSampleType(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestType As String, ByVal pTestID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.CountActiveByTestIDAndSampleType", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function DeleteByControlID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.DeleteByControlID", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function DeleteTestControlsByTestIDAndTestTypeNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.DeleteTestControlsByTestID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function GetControlsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestType As String, ByVal pTestID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetControls", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetTestControlsByControlIDNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetTestControlsByControlID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetTestControlsByControlIDListNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlIDList As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetTestControlsByControlIDList", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) And (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function SaveTestControlsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestControlsDS As TestControlsDS, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.SaveTestControls", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function UpdateTestControlsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestControlDS As TestControlsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.UpdateTestControls", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function VerifyLinkByQCModuleIDsNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCTestSampleID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.VerifyLinkByQCModuleIDs", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
...
#Region "TEMPORARY - TO SIMULATE QC RESULTS"
        ...
        Public Function GetAllNEW(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetAll", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetAdditionalInformationNEW(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestType As String, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetAdditionalInformationNEW", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
...
#Region "TO DELETE - OLD FUNCTIONS"
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        GlobalBase.CreateLogActivity(ex.Message, "TestControlsDelegate.GetAdditionalInformation", EventLogEntryType.Error, False)
        '    Finally
        '        If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
        '    End Try
        '    Return resultData
