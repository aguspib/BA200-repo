...
#Region "Public Methods"
        ...
        Public Function AddOrderTestsToSavedWS(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSOrderTests As SavedWSOrderTestsDS, _
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.AddOrderTestsToSavedWS", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function CancelAWOSInLISSavedWS(ByVal pDBConnection As SqlClient.SqlConnection, pAWOSID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.CancelAWOSInLISSavedWS", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function ClearDeletedElements(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.ClearDeletedElements", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function CountBySampleID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSampleID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.CountBySampleID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function Delete(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer, ByVal pSavedWSOrderTestID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.Delete", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function DeleteAll(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.DeleteAll", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function DeleteCALCInLISSavedWS(ByVal pDBConnection As SqlClient.SqlConnection, pSavedWSOrderTestsRow As SavedWSOrderTestsDS.tparSavedWSOrderTestsRow) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.DeleteCALCInLISSavedWS", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetAllDifferentPatients(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetAllDifferentPatients", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetAllLISOrderTestToReject(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetAllLISOrderTestToReject", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
        ...
        Public Function GetByAwosID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAwosID As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetByAwosID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing AndAlso Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetOrderTestsBySavedWSID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetOrderTestsBySavedWSID", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetOrderTestsToChangeAnalyzer(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetOrderTestsToChangeAnalyzer", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetSpecimensWithSeveralSampleTypes(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pSavedWSID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.GetSpecimensWithSeveralSampleTypes", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function UpdateAsManualOrderTest(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pAwosID As String, ByVal pTestID As Integer, ByVal pTestType As String, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.UpdateAsManualOrderTest", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function UpdateDeletedTestFlag(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pTestType As String, ByVal pTestID As Integer, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "SavedWSOrderTestsDelegate.UpdateDeletedTestFlag", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
