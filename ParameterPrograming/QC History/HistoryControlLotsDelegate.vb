...
#Region "Public Methods"
        ...
        Public Function CloseLotDeleteControl(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlID As Integer, _
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, " HistoryControlLotsDelegate.CloseLotDeleteControl", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHistoryControlLotsDS As HistoryControlLotsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "HistoryControlLotsDelegate.Create", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function GetLinkedTestsSampleTypesByControl(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, " HistoryControlLotsDelegate.GetLinkedTestsSampleTypesByControl", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function GetQCControlLotIDByControlIDAndLotNumber(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pControlID As Integer, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "HistoryControlLotsDelegate.GetQCControlLotIDByControlIDAndLotNumber", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
        ...
        Public Function Read(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pQCControlLotID As Integer) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "HistoryControlLotsDelegate.Read", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return myGlobalDataTO
