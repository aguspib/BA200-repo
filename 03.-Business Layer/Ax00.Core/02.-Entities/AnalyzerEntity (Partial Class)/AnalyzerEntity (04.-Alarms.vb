...
#Region "Main Manage Alarms treatment"
        ...
        ''' <param name="pErrorCodeList">Final error codes that generates the final alarm list to be processed</param>
        ...
        ''' AG 04/12/2014 BA-2146 add new optional parameters pErrorCodesList for store the error code that generates the alarm
        ''' </remarks>
        Private Function ManageAlarms(ByVal pdbConnection As SqlClient.SqlConnection, _
                                      ...
                                      Optional ByVal pAdditionalInfoList As List(Of String) = Nothing, _
                                      Optional ByVal pErrorCodeList As List(Of Integer) = Nothing) As GlobalDataTO
                    ...
                    If alarmIDItem <> GlobalEnumerates.Alarms.NONE Then
                        ...
                        If newRowFlag Then
                            ...
                            With alarmRow
                                ...
                                .SetErrorCodeNull()
                                If Not pErrorCodeList Is Nothing AndAlso Not String.Equals(pErrorCodeList(index), String.Empty) Then
                                    .ErrorCode = pErrorCodeList(index)
                                End If
                                'AG 04/12/2014 BA-2146
...
#Region "Individual alarm treatment Methods"
        ...
        ''' <param name="pErrorCode">Error code identifier</param>
        ''' <param name="pErrorCodeList">Final error codes that generates the final alarm list to be processed</param>
        ''' <remarks>
        ...
        Private Sub PrepareLocalAlarmList(ByVal pAlarmCode As GlobalEnumerates.Alarms, ByVal pAlarmStatus As Boolean, _
                                          ...
                                          Optional ByVal pAddAlwaysFlag As Boolean = False, _
                                          Optional ByVal pErrorCode As Integer = -1, Optional ByVal pErrorCodeList As List(Of Integer) = Nothing)
            ...
            If (pAlarmStatus) Then
                ...
                If (addFlag) Then
                    ...
                    If Not myAlarmListAttribute.Contains(pAlarmCode) Then
                        'AG 04/12/2014 BA-2146
                        AddLocalActiveAlarmToList(pAlarmCode, pAlarmList, pAlarmStatusList, pAddInfo, pAdditionalInfoList, pErrorCode, pErrorCodeList)
        ...
        ''' <remarks>AG 04/12/2014 BA-2146</remarks>
        Private Sub AddLocalActiveAlarmToList(ByVal pAlarmCode As GlobalEnumerates.Alarms, _
            ...
            Try
                ...
                End If
                'AG 04/12/2014 BA-2146 - There are alarms that can be generated by several error codes. We have to store the error code in order to show it into screen
                If Not pErrorCodeList Is Nothing AndAlso pErrorCode > 0 Then
                    pErrorCodeList.Add(pErrorCode)
                End If
