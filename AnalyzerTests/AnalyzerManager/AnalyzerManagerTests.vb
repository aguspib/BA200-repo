...
Imports Telerik.JustMock
        ...
        <TestMethod()> Public Sub ManageAnalyzerTest()

            Dim analyzerManager As IAnalyzerManager
            'Dim baseLine As BaseLineEntity = Mock.Create(Of IBaseLineEntity)()
            ...
            instruction.Add(New InstructionParameterTO With {.InstructionType = "AC", .ParameterIndex = 4, .ParameterValue = "1"}) '!!!!!
            ...
            instruction.Add(New InstructionParameterTO With {.InstructionType = "E", .ParameterIndex = 9, .ParameterValue = "70"})
