...
#Region " CLASS DEFINITION "
    ...
    Public Class DataGridViewNumericUpDownCell
        ...
        Friend Const DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMaximum As Decimal = CDec(100.0R)
        ...
        Public Overloads Overrides ReadOnly Property ValueType() As Type
            Get
                Dim valuetp As Type = MyBase.ValueType
        ...
        ''' </summary>C:\Tools\Tradex_Tools\WindowsApplication1\Controls\DataGridViewNumericUpDownEditingControl.vb
            ...
            If Not String.IsNullOrEmpty(formattedNumber) AndAlso value IsNot Nothing Then
                ...
                If unformattedDecimal = formattedDecimal Then
                    ...
                    If Me.ThousandsSeparator Then
                        Return formattedDecimal.ToString("N" + Me.DecimalPlaces.ToString())
                    Else
                        Return formattedDecimal.ToString("F" + Me.DecimalPlaces.ToString())
                    End If
        ...
        Public Overloads Overrides Function KeyEntersEditMode(ByVal e As KeyEventArgs) As Boolean
            ...
            If Not String.IsNullOrEmpty(negativeSignStr) AndAlso negativeSignStr.Length = 1 Then
                negativeSignKey = DirectCast(AscW(ChrW((VkKeyScan(negativeSignStr(0))))), Keys)
            End If
        ...
        ''' </summary>
        Public Overloads Overrides Sub PositionEditingControl(ByVal setLocation As Boolean, ByVal setSize As Boolean, ByVal cellBounds As Rectangle, ByVal cellClip As Rectangle, ByVal cellStyle As DataGridViewCellStyle, ByVal singleVerticalBorderAdded As Boolean, _
