...
namespace Biosystems.Ax00.Controls.UserControls
{
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, defaultButton, Button1Text, Button2Text, Button3Text);
        }
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.richTextBoxMessage.WordWrap = true;
                // 
                // panel1
                // 
            ...
            private enum BUTTON_TEXT { OK = 0, CANCEL, YES, NO, ABORT, RETRY, IGNORE, };
            private static readonly String[] BUTTON_TEXTS_ENGLISH = { "OK", "Cancel", "Yes", "No", "Abort", "Retry", "Ignore" };
            private static readonly String[] BUTTON_TEXTS_GERMAN = { "OK", "Abbrechen", "Ja", "Nein", "Abbrechen", "Wiederholen", "Ignorieren" };
            ...
            private FlexibleMessageBoxForm()
            {
                ...
                this._isCultureGerman = CultureInfo.InstalledUICulture.TwoLetterISOLanguageName.Contains("de");
            }
            ...
            private string GetButtonText(BUTTON_TEXT buttonTextIndex)
            {
                return this._isCultureGerman ? BUTTON_TEXTS_GERMAN[Convert.ToInt32(buttonTextIndex)]
                                             : BUTTON_TEXTS_ENGLISH[Convert.ToInt32(buttonTextIndex)];
            }
            ...
            private static void SetDialogStartPosition(FlexibleMessageBoxForm flexibleMessageBoxForm, IWin32Window owner)
            {
                ...
                if (owner == null)
                {
                    ...
                    flexibleMessageBoxForm.FormBorderStyle = FormBorderStyle.FixedSingle;
                }
            }
            ...
            /// <param name="buttons">The buttons.</param>
            /// <param name="defaultButton">The default button.</param>
            /// <remarks >AG 05/12/2013 - Set property AutoSize = True</remarks>
                ...
                string button1Text, string button2Text, string button3Text)
            {
                ...
                switch (buttons)
                {
                    case MessageBoxButtons.AbortRetryIgnore:
                        ...
                        flexibleMessageBoxForm.button1.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button1.Visible = true;
                        flexibleMessageBoxForm.button1.Text = button1Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.ABORT) : button1Text;
                        flexibleMessageBoxForm.button1.DialogResult = DialogResult.Abort;

                        flexibleMessageBoxForm.button2.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button2.Visible = true;
                        flexibleMessageBoxForm.button2.Text = button2Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.RETRY) : button2Text;
                        flexibleMessageBoxForm.button2.DialogResult = DialogResult.Retry;

                        flexibleMessageBoxForm.button3.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button3.Visible = true;
                        flexibleMessageBoxForm.button3.Text = button3Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.IGNORE) : button3Text;
                    ...
                    case MessageBoxButtons.OKCancel:
                        ...
                        flexibleMessageBoxForm.button2.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button2.Visible = true;
                        flexibleMessageBoxForm.button2.Text = button2Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.OK) : button2Text;
                        flexibleMessageBoxForm.button2.DialogResult = DialogResult.OK;

                        flexibleMessageBoxForm.button3.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button3.Visible = true;
                        flexibleMessageBoxForm.button3.Text = button3Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.CANCEL) : button3Text;
                    ...
                    case MessageBoxButtons.YesNo:
                        ...
                        flexibleMessageBoxForm.button2.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button2.Visible = true;
                        flexibleMessageBoxForm.button2.Text = button2Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.YES) : button2Text;
                        flexibleMessageBoxForm.button2.DialogResult = DialogResult.Yes;

                        flexibleMessageBoxForm.button3.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button3.Visible = true;
                        flexibleMessageBoxForm.button3.Text = button3Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.NO) : button3Text;
                    ...
                    case MessageBoxButtons.YesNoCancel:
                        ...
                        flexibleMessageBoxForm.button1.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button1.Visible = true;
                        flexibleMessageBoxForm.button1.Text = button1Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.YES) : button1Text;
                        flexibleMessageBoxForm.button1.DialogResult = DialogResult.Yes;

                        flexibleMessageBoxForm.button2.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button2.Visible = true;
                        flexibleMessageBoxForm.button2.Text = button2Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.NO) : button2Text;
                    ...
                    default:
                        ...
                        flexibleMessageBoxForm.button3.AutoSize = true; //AG 05/12/2013
                        flexibleMessageBoxForm.button3.Visible = true;
                        flexibleMessageBoxForm.button3.Text = button3Text == "" ? flexibleMessageBoxForm.GetButtonText(BUTTON_TEXT.OK) : button1Text;
