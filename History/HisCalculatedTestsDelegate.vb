...
#Region "Public Methods"
        ...
        Public Function CheckCalculatedTestsInHistorics(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisCalculatedTestsDS As HisCalculatedTestsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "HisCalculatedTestsDelegate.CheckCalculatedTestsInHistorics", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function DeleteClosedNotInUse(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HisCalculatedTestsDelegate.DeleteClosedNotInUse", EventLogEntryType.Error, False)
            Finally
