...
#Region "Public Methods"
        ...
        Public Function CheckReagentsInHistorics(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisReagentsDS As HisReagentsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "HisReagentsDelegate.CheckReagentsInHistorics", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function DeleteClosedNotInUse(ByVal pDBConnection As SqlClient.SqlConnection) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HisReagentsDelegate.DeleteClosedNotInUse", EventLogEntryType.Error, False)
            Finally
