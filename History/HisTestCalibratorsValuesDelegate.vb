...
#Region "Public Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHistTestID As Integer, ByVal pSampleType As String, ByVal pTestVersionNum As Integer, _
            ...
            Try
                ...
                If (Not resultData.HasError AndAlso Not resultData.SetDatos Is Nothing) Then
                    ...
                    If (Not dbConnection Is Nothing) Then
                        ...
                        resultData = myDAO.Create(dbConnection, pHistTestID, pSampleType, pTestVersionNum, pHistCalibratorID, pCalibratorsDS)
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "HisTestCalibratorsValuesDelegate.Create", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function DeleteByHistTestID(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHistTestID As Integer, ByVal pSampleType As String, _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "HisTestCalibratorsValuesDelegate.DeleteByHistTestID", EventLogEntryType.Error, False)
            Finally
