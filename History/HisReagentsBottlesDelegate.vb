...
#Region "C R U D"
        ...
        Public Function Read(ByVal pDBConnection As SqlConnection, ByVal pHistoryReagentBottlesDS As HisReagentsBottlesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "HistoryReagentBottlesDelegate.Read", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function Update(ByVal pDBConnection As SqlConnection, ByVal pHistoryReagentBottlesDS As HisReagentsBottlesDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HistoryReagentBottlesDelegate.Update", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) And (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
        ...
        Public Function ReadByBarCode(ByVal pDBConnection As SqlConnection, ByVal pBarCode As String) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HistoryReagentBottlesDelegate.ReadByBarCode", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) And (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
        ...
        Public Function CreateReagentsBottle(ByVal pDBConnection As SqlClient.SqlConnection, _
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HisReagentBottlesDelegate.CreateReagentsBottle", EventLogEntryType.Error, False)
            Finally
