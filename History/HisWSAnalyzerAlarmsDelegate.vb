...
#Region "Public Methods"
        ...
        Public Function GetAlarmsMonitor(ByVal pDBConnection As SqlClient.SqlConnection, Optional ByVal pAnalyzerID As String = "", _
            ...
            Catch ex As Exception
                ...
                myLogAcciones.CreateLogActivity(ex.Message, "HisWSAnalyzerAlarmsDelegate.GetAlarmsMonitor", EventLogEntryType.Error, False)
        ...
        Public Function Delete(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisAnalyzerAlarmsDS As HisWSAnalyzerAlarmsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HisWSAnalyzerAlarmsDelegate.Delete", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisAnalyzerAlarmsDS As HisWSAnalyzerAlarmsDS) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                Dim myLogAcciones As New ApplicationLogManager()
                myLogAcciones.CreateLogActivity(ex.Message, "HisWSAnalyzerAlarmsDelegate.Create", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
...
#Region "NOT USED"
        ...
        '        Dim myLogAcciones As New ApplicationLogManager()
        '        myLogAcciones.CreateLogActivity(ex.Message, "HisWSAnalyzerAlarmsDelegate.DeleteByAnalyzerWS", EventLogEntryType.Error, False)
        '    Finally
        '        If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
        '    End Try
        '    Return resultData
