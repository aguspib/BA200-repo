...
#Region "Public Methods"
        ...
        Public Function Create(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisWSCalcTestsRelationsDS As HisWSCalcTestRelations) As GlobalDataTO
            ...
            Catch ex As Exception
                ...
                GlobalBase.CreateLogActivity(ex.Message, "HisWSCalcTestsRelationsDelegate.Create", EventLogEntryType.Error, False)
            Finally
        ...
        Public Function MarkExcludedExpTests(ByVal pDBConnection As SqlClient.SqlConnection, ByVal pHisResultsDataTable As List(Of HisWSResultsDS.vhisWSResultsRow), _
            ...
            Catch ex As Exception
                ...
                'Dim myLogAcciones As New ApplicationLogManager()
                GlobalBase.CreateLogActivity(ex.Message, "HisWSCalcTestsRelationsDelegate.MarkExcludedExpTests", EventLogEntryType.Error, False)
            Finally
                If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
            End Try
            Return resultData
...
#Region "NOT USED"
        ...
        '        'Dim myLogAcciones As New ApplicationLogManager()
        '        GlobalBase.CreateLogActivity(ex.Message, "HisWSCalcTestsRelationsDelegate.DeleteByHistOrderTestIDCALC", EventLogEntryType.Error, False)
        '    Finally
        '        If (pDBConnection Is Nothing) AndAlso (Not dbConnection Is Nothing) Then dbConnection.Close()
        '    End Try
        '    Return resultData
        ...
        '        'Dim myLogAcciones As New ApplicationLogManager()
        '        GlobalBase.CreateLogActivity(ex.Message, "HisWSCalcTestsRelationsDelegate.ReadByHistOrderTestID", EventLogEntryType.Error, False)
